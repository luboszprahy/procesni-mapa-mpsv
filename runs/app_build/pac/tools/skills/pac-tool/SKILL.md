---
name: pac-tool
description: "PAC CLI tool command group skill. It can be run as `pac tool` if PAC CLI is installed or with .NET dnx command: `dnx Microsoft.PowerApps.CLI.Tool --yes tool ...`. Power Platform tools that can be installed and launched. List of supported commands: admin, cmt, init-skills, list, maker, pd, prt"
---
...
- [tool admin](admin.md)
- [tool cmt](cmt.md)
- [tool init-skills](init-skills.md)
- [tool list](list.md)
- [tool maker](maker.md)
- [tool pd](pd.md)
- [tool prt](prt.md)
