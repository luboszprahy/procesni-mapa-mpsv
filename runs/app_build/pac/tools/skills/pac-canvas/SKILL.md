---
name: pac-canvas
description: "PAC CLI canvas command group skill. It can be run as `pac canvas` if PAC CLI is installed or with .NET dnx command: `dnx Microsoft.PowerApps.CLI.Tool --yes canvas ...`. Operating with Power Apps .msapp files. List of supported commands: create, download, list, pack, unpack"
---
...
- [canvas create](create.md)
- [canvas download](download.md)
- [canvas list](list.md)
- [canvas pack](pack.md)
- [canvas unpack](unpack.md)
