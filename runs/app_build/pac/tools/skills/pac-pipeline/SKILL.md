---
name: pac-pipeline
description: "PAC CLI pipeline command group skill. It can be run as `pac pipeline` if PAC CLI is installed or with .NET dnx command: `dnx Microsoft.PowerApps.CLI.Tool --yes pipeline ...`. Work with Pipelines. List of supported commands: deploy, list"
---
