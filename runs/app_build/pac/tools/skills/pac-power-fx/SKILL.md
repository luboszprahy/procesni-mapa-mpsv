---
name: pac-power-fx
description: "PAC CLI power-fx command group skill. It can be run as `pac power-fx` if PAC CLI is installed or with .NET dnx command: `dnx Microsoft.PowerApps.CLI.Tool --yes power-fx ...`. (Preview) Commands for working with Power Fx. List of supported commands: repl, run"
---
