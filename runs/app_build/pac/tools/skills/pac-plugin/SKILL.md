---
name: pac-plugin
description: "PAC CLI plugin command group skill. It can be run as `pac plugin` if PAC CLI is installed or with .NET dnx command: `dnx Microsoft.PowerApps.CLI.Tool --yes plugin ...`. Commands for working with Dataverse plug-in class library. List of supported commands: init, push"
---
