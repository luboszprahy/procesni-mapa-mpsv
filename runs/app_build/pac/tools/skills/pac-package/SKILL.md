---
name: pac-package
description: "PAC CLI package command group skill. It can be run as `pac package` if PAC CLI is installed or with .NET dnx command: `dnx Microsoft.PowerApps.CLI.Tool --yes package ...`. Commands for working with Dataverse package projects. List of supported commands: add-external-package, add-reference, add-solution, deploy, init, show"
---
...
- [package add-external-package](add-external-package.md)
- [package add-reference](add-reference.md)
- [package add-solution](add-solution.md)
- [package deploy](deploy.md)
- [package init](init.md)
- [package show](show.md)
