---
name: pac-help
description: "PAC CLI help command group skill. It can be run as `pac help` if PAC CLI is installed or with .NET dnx command: `dnx Microsoft.PowerApps.CLI.Tool --yes help ...`. Show help for the Microsoft Power Platform CLI. List of supported commands: help"
---
