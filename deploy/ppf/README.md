<!-- GENEROVÁNO src/make_deploy_ppf.py — needituj ručně.
     Zdroj textu: src/sablona_instalace_ppf.md, čísla z balíku procesnimapa_1_0_0_104.zip. -->

# Instalace balíku `procesnimapa_1_0_0_104.zip`
...
> generuje (`src/make_deploy_mpsv.py`) a je aktuální pro týž balík 1.0.0.104;
...
Power Apps → **Solutions → Import solution** → `procesnimapa_1_0_0_104.zip`
